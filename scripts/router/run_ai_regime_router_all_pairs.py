...
def main() -> None:
    ...
    parser.add_argument("--switch-min-hold-days", type=int, default=30)
    parser.add_argument(
        "--sensitiveness",
        default=None,
        choices=[
        ...
        help="Optional router switch posture. If omitted, the original non-sensitivity rules are used.",
    )
    parser.add_argument(
        "--router-ablation",
        choices=[
    ...
    parser.add_argument("--switch-decision-max-output-tokens", type=int, default=64)
    parser.add_argument("--selection-max-output-tokens", type=int, default=96)
    ...
    params.update(
        {
            ...
            "switch_min_hold_days": args.switch_min_hold_days,
    ...
    if args.sensitiveness is not None:
        params["sensitiveness"] = args.sensitiveness
    else:
        params.pop("sensitiveness", None)
    ...
    print(
        ...
        f"switch_min_hold_days={args.switch_min_hold_days} "
        f"sensitiveness={args.sensitiveness or 'OFF'} "
