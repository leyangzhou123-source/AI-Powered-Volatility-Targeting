...
class AIRegimeRouter(Router):
    ...
    def _call_ai(
        ...
        token_limit = int(max_output_tokens or self.max_output_tokens)
    ...
    def _switch_decision_payload(
        ...
        payload = {
            "instruction": (
                ...
                "Switch if regime/context changed, active recent rank is weak, or drawdown is high. "
                "Hold if active recent rank and drawdown are strong."
            ),
    ...
    def _deterministic_switch_response(
        ...
        should_switch = (
            bool(regime_changed)
            or bool(best_name and best_score >= active_score - 0.02)
            or bool(active_drawdown > 0.08 and best_name and best_score >= active_score - 0.10)
        )
        return {
    ...
    def _deterministic_selection_response(
        ...
        return {
            ...
            "score_rule": "sharpe - 3.5*drawdown - 2.0*cvar - 1.25*drawdown_consistency_penalty",
        }
